...
public interface CodeInput extends HasText, HasPlaceholder, IsWidget, HasLiveValueChangeHandlers, HasKeyDownHandlers, HasKeyUpHandlers,
		HasValueChangeHandlers<String>, HasAllFocusHandlers, Focusable {
