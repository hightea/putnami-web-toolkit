...
public class FormStaticControlsView extends Composite {
	...
	interface Binder extends UiBinderLocalized<Widget, FormStaticControlsView> {
	...
	@UiConstructor
	public FormStaticControlsView(NavSpy navSpy) {
		this.navSpy = navSpy;
