...
public class TablesPlace extends MvpPlace {

	public static final TablesPlace INSTANCE = new TablesPlace();

	public TablesPlace() {
		super((ViewProxy) GWT.create(TablesView.class), null);
	}

	@Override
	public MvpPlace getPlace(String token) {
		return TablesPlace.INSTANCE;
	}
}
