...
public class Tuto5IssueTrackerPage extends Page {
	@ActivityDescription(view = Tuto5IssueTrackerPage.class, aliases = "Tuto5", viewDecorator = SummaryDecorator.class)
	public static class Tuto5IssueTrackerPlace extends ViewPlace {
	}
}
