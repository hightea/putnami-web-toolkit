 ...
 */
package fr.putnami.pwt.doc.client.page.spring;
...
@Templated
public class SpringPage extends Page {
	@ActivityDescription(view = SpringPage.class, viewDecorator = SummaryDecorator.class)
	public static class SpringPlace extends ViewPlace {
	}
