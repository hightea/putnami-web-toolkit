...
public class Tuto4BindAFormPage extends Page {
	@ActivityDescription(view = Tuto4BindAFormPage.class, aliases = "Tuto4", viewDecorator = SummaryDecorator.class)
	public static class Tuto4BindAFormPlace extends ViewPlace {
	}
}
