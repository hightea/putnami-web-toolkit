...
public class MorePlace extends MvpPlace {

	public static final MorePlace INSTANCE = new MorePlace();

	public MorePlace() {
		super((ViewProxy) GWT.create(MoreView.class), null);
	}

	@Override
	public MvpPlace getPlace(String token) {
		return MorePlace.INSTANCE;
	}
}
