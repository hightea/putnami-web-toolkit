...
@Templated
public class AjaxBotIndexingPage extends Page {
	@ActivityDescription(view = AjaxBotIndexingPage.class, viewDecorator = SummaryDecorator.class)
	public static class AjaxBotIndexingPlace extends ViewPlace {
	}
