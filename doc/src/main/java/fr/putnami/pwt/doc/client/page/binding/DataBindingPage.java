...
public class DataBindingPage extends Page {
	...
	public void postConstruct() {
		...
		this.beanForm.edit(new Person());
		this.fieldsetForm.edit(new Person());
		this.tableEditor.edit(people);
		this.outputListEditor.edit(people);
		this.inputListEditor.edit(people);
	}
