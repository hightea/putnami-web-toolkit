...
public class ServiceBinderGenerator extends Generator {
	...
	@Override
	public String generate(TreeLogger logger, GeneratorContext context, String remoteServiceClassName) throws UnableToCompleteException {
		...
		if (serviceType == null) {
			logger.log(TreeLogger.ERROR, remoteServiceType.getQualifiedSourceName()
					+ " must implement " + ServiceProxy.class.getCanonicalName(), null);
			throw new UnableToCompleteException();
		}
