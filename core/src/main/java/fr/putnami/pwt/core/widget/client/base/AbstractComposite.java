...
public abstract class AbstractComposite extends Composite implements HasResponsiveVisibility, CloneableWidget {
	...
	protected AbstractComposite(AbstractComposite source) {
		...
		styleToClone = source.getElement().getClassName();
	}

	@Override
	protected void initWidget(Widget widget) {
		super.initWidget(widget);
		if (styleToClone != null) {
			getElement().setClassName(styleToClone);
			styleToClone = null;
		}
		else {
