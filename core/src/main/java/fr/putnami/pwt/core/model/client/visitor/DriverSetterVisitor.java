...
public class DriverSetterVisitor extends AbstractVisitor {

	@Override
	public <A, B extends Editor> boolean visit(Context<B> context) {
		Editor editor = context.getEditor();
		if (editor instanceof HasDriver && ((HasDriver) editor).getDriver() == null) {
			((HasDriver) editor).setDriver(context.getDriver());
		}
		return true;
	}
