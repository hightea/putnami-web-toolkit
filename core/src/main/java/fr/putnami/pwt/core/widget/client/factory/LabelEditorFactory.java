...
public class LabelEditorFactory implements LabelFactory {

	public static final LabelEditorFactory INSTANCE = new LabelEditorFactory();

	@Override
	public EditorLabel newLabel() {
		return new Label();
	}
}
