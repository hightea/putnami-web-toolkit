...
public class SimpleCollapse extends AbstractDropdown {
	...
	private static final CssStyle STYLE_MENU_ITEM_HEADING = new SimpleStyle("list-group-item-heading");
	...
	public SimpleCollapse(String tagName) {
		super(tagName);
		StyleUtils.addStyle(anchor, STYLE_PANEL_HEADING);
		StyleUtils.addStyle(menuContainer, STYLE_MENU);
		StyleUtils.addStyle(this, STYLE_PANEL);
		StyleUtils.addStyle(this, STYLE_PANEL_DEFAULT);
		collapseHelper = CollapseHelper.apply(anchor, menuContainer.getElement(), true);
	}
