...
public class PcpSerializerGenerator extends Generator {
	...
	public String generate(TreeLogger logger, GeneratorContext context, String modelClass)
		...
		PcpSerializerCreator serializerCreator = new PcpSerializerCreator(beanType);
		return serializerCreator.create(logger, context);
	}
